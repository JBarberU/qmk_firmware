...
#define MO_Gr MO(L_GAMING_RAISE)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [L_RAISE] = LAYOUT(
        QK_BOOT, KC_NO,   KC_NO,   KC_NO,   JB_CLW,   KC_NO,                        KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   TO(L_GAMING_BASE),
    ...
    [L_GAMING_BASE] = LAYOUT(
        KC_NO,   KC_1,    KC_2,    KC_3,    KC_4,     KC_5,                         KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  TO(L_BASE),
        KC_TAB,  KC_NO,   KC_Q,    KC_W,    KC_E,     KC_R,                         KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_LBRC,
        KC_ESC,  KC_LSFT, KC_A,    KC_S,    KC_D,     KC_F,                         KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,
        KC_NO,   KC_LCTL, KC_Z,    KC_X,    KC_C,     KC_V,                         KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,
        KC_NO,   KC_LALT,          KC_M,    KC_N,     MO_Gr,    KC_SPC,   KC_RSFT,  MO_Lo,   KC_ENT,  KC_RALT,          KC_NO,   KC_NO
    ),
    [L_GAMING_RAISE] = LAYOUT(
        KC_NO,   KC_6,    KC_7,    KC_8,    KC_9,     KC_0,                         KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  TO(L_BASE),
        KC_TAB,  KC_NO,   KC_Q,    KC_W,    KC_E,     KC_R,                         KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_LBRC,
        KC_ESC,  KC_LSFT, KC_A,    KC_S,    KC_D,     KC_F,                         KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,
        KC_NO,   KC_LCTL, KC_Z,    KC_X,    KC_C,     KC_V,                         KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,
        KC_NO,   KC_LALT,          KC_M,    KC_N,     KC_TRNS,  KC_SPC,   KC_RSFT,  MO_Lo,   KC_ENT,  KC_RALT,          KC_NO,   KC_NO
    )
    /* Blank layer
    [<< layer name >>] = LAYOUT(
        KC_NO,   KC_NO,  KC_NO,   KC_NO,   KC_NO,    KC_NO,                        KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,
